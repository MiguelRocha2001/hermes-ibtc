...
use crate::{
    chain::{
        cosmos::CosmosSdkChain, handle::ChainHandle, ibtc::IbtcChain, namada::NamadaChain, penumbra::PenumbraChain, runtime::ChainRuntime
    },
...
pub fn spawn_chain_runtime_with_config<Handle: ChainHandle>(
    ...
    let handle = match config {
        ...
        ChainConfig::Ibtc(_) => ChainRuntime::<IbtcChain>::spawn(config, rt),
    }
